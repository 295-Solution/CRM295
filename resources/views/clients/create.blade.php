...
<head>
    ...
    <title>Tambah Client - CRM295</title>
...
<div class="app-shell">
    ...
    <main class="app-main">
        <div class="container">
            ...
            <p class="page-subtitle">Lengkapi data client agar tim memiliki data kontak yang rapi dan konsisten.</p>
                ...
                <form method="POST" action="{{ route('clients.store') }}">
                    ...
                    <div class="form-grid">
                        ...
                        <div>
                            ...
                            <input class="form-control" id="perusahaan" type="text" name="perusahaan" value="{{ old('perusahaan') }}">
                            @error('perusahaan') <div class="error">{{ $message }}</div> @enderror
                        </div>

                        <div>
                            <label class="form-label" for="nomor_wa">Nomor WA</label>
                            <input class="form-control" id="nomor_wa" type="text" name="nomor_wa" value="{{ old('nomor_wa') }}" required>
